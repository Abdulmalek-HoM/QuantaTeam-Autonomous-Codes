...
public class autoTrajectoryTest2 extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if (driveOut.leftFront.isBusy()&& driveOut.leftBack.isBusy() && driveOut.rightFront.isBusy() && driveOut.rightBack.isBusy()) {
            idle();
        }
